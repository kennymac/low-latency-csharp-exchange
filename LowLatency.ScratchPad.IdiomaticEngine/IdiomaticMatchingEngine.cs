...
public sealed class IdiomaticMatchingEngine
{
    public const int MaxTickers = 100;
    private readonly IdiomaticOrderBook?[] _orderBooks = new IdiomaticOrderBook?[MaxTickers];
    ...
    public IdiomaticMatchingEngine(
